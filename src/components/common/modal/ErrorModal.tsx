            ...
            <ClickOutside onClick={() => handleClose()}>
              <div className="relative p-4 text-center min-w-96 bg-white rounded-lg shadow  sm:p-5">
                ...
                <button
                  ...
                  type="button"
                  className="py-2 px-3 text-sm font-medium text-center text-white rounded-lg bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-green-300 "
